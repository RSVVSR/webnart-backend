...
//GET REQUEST
router.route('/profile/').get(authToken, getAllUser);
router.route('/profile/:username').get(authToken, getProfileByUsername);
router.route('/profile/infoData/:username').get(authToken, getInfoAccordingTokey);

//POST REQUEST
router.route('/profile/:username').post(authToken, updateUserKeys);

//DELETE REQUEST
router.route('/profile/:username').delete(authToken, deleteUserByUsername);
